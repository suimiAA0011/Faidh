...
struct invesAnalysis: View {
    ...
    var body: some View {
        ...
        ZStack {
            pieChartrender(values: [699,1110], colors: [Color(red: -0.157, green: 0.392, blue: 0.606),Color(red: 0.793, green: 0.479, blue: 0.389)], backgroundColor: Color(red: -0.063, green: 0.184, blue: 0.304), innerRadiusFraction: 0.5).padding(.top, 10.0).offset(x:100,y:70)
            HStack{
